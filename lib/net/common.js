/*!
 * common.js - p2p constants for bcoin-abc
...
exports.COMPACT_MAX_VERSION = 70015;
...
exports.services = {
  ...
  /**
   * Whether the peer supports Bitcoin Cash.
   */
...
/**
 * Default user agent: `/bcash:[version]/`.
 * @const {String}
 * @default
 */

exports.USER_AGENT = `/bcoin-abc:${pkg.version}/`;

/**
 * Max message size (~8mb with new chain, formerly 1mb)
 * @const {Number}
 * @default
 */

exports.MAX_MESSAGE = 32 * 1000 * 1000;
