...
function BlockPacket(block) {
  if (!(this instanceof BlockPacket))
    return new BlockPacket(block);
...
function TXPacket(tx) {
  if (!(this instanceof TXPacket))
    return new TXPacket(tx);
...
function CmpctBlockPacket(block) {
  if (!(this instanceof CmpctBlockPacket))
    return new CmpctBlockPacket(block);
...
function BlockTxnPacket(response) {
  if (!(this instanceof BlockTxnPacket))
    return new BlockTxnPacket(response);
