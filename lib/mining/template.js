...
BlockTemplate.prototype.getHash = function getHash() {
...
BlockTemplate.prototype.getScript = function getScript() {
 ...
 * @param {Buffer} hash - Commitment hash.
 * @returns {TX}
 */
...
BlockTemplate.prototype.addTX = function addTX(tx, view) {
  ...
  const size = item.tx.getBaseSize();
