/*!
 * network.js - bitcoin networks for bcash
...
main.seeds = [
  'seed.bitcoinabc.org', // BITCOIN-ABC
  'seed.bitprim.org', // Bitprim
  'seed.deadalnix.me', // Amaury Sechet
  'btccash-seeder.bitcoinunlimited.info', // Bitcoin Unlimited
  'seed-abc.bitcoinforks.org', // Bitcoinforks Seeder
  'seeder.criptolayer.net' // Criptolayer
];
...
/**
 * Packet magic number (bcash)
 * @const {Number}
 * @default
 */

main.netmagic = 0xe8f3e1e3;
...
main.checkpointMap = {
  ...
  478577: '3bae86eff4775a05acb8f089ef9f9dc9a123019ae19b63000000000000000000',
  // Difficulty Adjustment Algorithm Fork (Nov. 13)
...
main.block = {
  ...
  UAHFHash: 'ec5e1a193601f25ff1d94b421ddead0dbefcb99cf91e65000000000000000000',

  /**
   * Height in which the Difficulty Adjustment Algorithm
   * occurs (November 13th 2017)
   */

  daaHeight: 504031,

  /**
   * Time in which the Monolith Block-Size
   * Hard Fork occurs (May 15th 2018)
   */

  monolithActivation: 1526400000,

  /**
   * Time in which the Magnetic Anomaly
   * Hark Fork occurs (Nov 15th 2018)
   */

  magneticAnomaly: 1542300000,

  /**
   * height in which Replay Commitment
  ...
  /**
   * Replay commitment vector
   */

  antiReplayOpReturnCommitment: 'Bitcoin: A Peer-to-Peer Electronic Cash System',
...
testnet.seeds = [
  'testnet-seed-abc.bitcoinforks.org', // bitcoinforks seeder
  'testnet-seeder.criptolayer.net', // criptolayer
  'testnet-seed.bitprim.org', // bitprim
  'testnet-seed.deadalnix.me', // Amaury Sechet
  'testnet-seed.bitcoinabc.org' // bitcoinabc
];

testnet.magic = 0x0709110b;

testnet.netmagic = 0xf4f3e5f4;
...
testnet.checkpointMap = {
  ...
  1155876: 'f5b885a2a40e9a0cf77ed39fbac2d51538f47d2a58d93ef9fe380e0000000000',
  1188697: 'fb47e0ab0d2448f71192a09fe61bc9c46cd3b4e7bd778091d00e170000000000'
};

testnet.lastCheckpoint = 1155876;
...
regtest.netmagic = 0xfabfb5da;

regtest.port = 48444;

regtest.checkpointMap = {
  0: '06226e46111a0b59caaf126043eb5bbf28c34f3a5e332a1fc7b2b73cf188910f'
};
...
regtest.feeRate = 10000;

regtest.maxFeeRate = 10000;
