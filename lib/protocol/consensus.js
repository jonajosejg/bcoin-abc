...
/**
 * Default block size (consensus)
 * @const {Number}
 * @default
 */

exports.DEFAULT_BLOCK_SIZE = 1000000;

/**
 * Maximum Transaction Size Calculation (1MB / 10^6)
 * @const {Number}
 * @default
 */

exports.ONE_MEGABYTE = 1000000;
/**
...
exports.MAX_BLOCK_SIZE = 8000000;

/**
 * Maximum block size generated (protocol).
 * @const {Number}
 * @default
 */

exports.MAX_GENERATED_BLOCK_SIZE = 2000000;
...
exports.MAX_BLOCK_SIGOPS = 20000
/**
 * Maximum number of signature check
 * operations allowed per transaction.
 * @const {Number}
 * @default
 */

exports.MAX_TX_SIGOPS_COUNT = 20000;
...
/**
 * total bits available in versiobits
 */

exports.VERSION_NUM_BITS = 29;
...
/**
 * Numeric opcodes (OP_1ADD, etc) are resricted to 4-byte integers.
 * @const {Number}
 * @defualt
 */

exports.MAX_ELEMENT_BYTESIZE = 4;
...
exports.getMaxBlockSigopsCount = function getMaxBlockSigopsCount(block) {
  const mbRoundedUp = 1 + ((block - 1) / exports.ONE_MEGABYTE | 0);
  return mbRoundedUp * exports.MAX_BLOCK_SIGOPS;
};
