...
function Network(options) {
  ...
  this.netmagic = options.netmagic;
...
/**
 * Get Bitcoin Cash magic number.
 * @param {Number} value
 * @param {Network?} network
 * @returns {Network}
 */

Network.cashMagic = function cashMagic(value, network) {
  return Network.by(value, cmpNetMagic, network, 'magic number');
};
...
function cmpNetMagic(newtork, netmagic) {
  return network.netmagic === netmagic;
}
