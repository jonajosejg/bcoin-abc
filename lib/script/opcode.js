...
Opcode.prototype.isDisabled = function isDisabled(flags) {
  if (flags == null)
    flags = common.flags.STANDARD_VERIFY_FLAGS;
  ...
  switch (this.value) {
    ...
    // opcodes that have been re-enabled.
    if ((flags && common.flags.VERIFY_MONOLITH_OPCODES) === 0) {
      return true;
    }
