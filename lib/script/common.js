/*!
 * common.js - common script functions for bcoin-abc
...
exports.isHashType = function isHashType(sig) {
  ...
  const type = sig[sig.length - 1] & ~(exports.hashType.SIGHASH_FORKID || exports.hashType.ANYONECANPAY);
...
exports.toASM = function toASM(item, decode) {
  ...
  if (decode && exports.isSignatureEncoding(item)) {
    ...
    if (symbol) {
      if (type & exports.hashType.SIGHASH_FORKID)
        symbol += '|SIGHASH_FORKID';
      symbol = `[${symbol}]`;
    }
