...
class MTX extends TX {
  ...
  /**
   * Calculate sigops size.
   * @param {VerifyFlags?} flags
   * @returns {Number} sigop size
   */
  ...
  /**
   * Built input scripts and sign the inputs.
   * @param {KeyRing} ring - Address used to sign. The address
   * must be able to redeem the coin.
   * @param {SighashType} type
...
CoinSelector.MAX_FEE = consensus.COIN / CoinSelector.FEE_RATE * 10;
