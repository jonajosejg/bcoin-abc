/*!
 * workerpool.js - worker processes for bcoin-abc
...
class WorkerPool extends EventEmitter {
  ...
  constructor(options) {
    ...
    this.size = getCores();
    this.timeout = 120000;
    this.file = process.env.BCASH_WORKER_FILE || 'worker.js';
...
class Worker extends EventEmitter {
  ...
  listen() {
    ...
    this.sendEnv({
      BCASH_WORKER_NETWORK: Network.type,
      BCASH_WORKER_ISTTY: process.stdout
